...
- Broader test coverage: the remaining admin CRUD controllers (initiative questions, attendance, question library, grades) don't have dedicated tests yet — the existing `@WebMvcTest`s establish the pattern to extend to them
